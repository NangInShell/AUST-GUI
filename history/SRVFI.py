...
# Form implementation generated from reading ui file 'SRVFI.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Box_preset.addItem("")
        self.Box_preset.addItem("")
        self.Box_encode = QtWidgets.QComboBox(self.tab_2)
        self.Box_encode.setGeometry(QtCore.QRect(10, 40, 71, 41))
        self.Box_encode.setObjectName("Box_encode")
        self.Box_encode.addItem("")
        ...
        self.label_encode.setGeometry(QtCore.QRect(10, 10, 71, 31))
        ...
        self.encode_vcode.setGeometry(QtCore.QRect(110, 40, 71, 41))
        self.encode_vcode.setObjectName("encode_vcode")
        self.encode_vcode.addItem("")
        self.encode_vcode.addItem("")
        self.label_vcode = QtWidgets.QLabel(self.tab_2)
        self.label_vcode.setGeometry(QtCore.QRect(110, 10, 71, 31))
        self.label_vcode.setObjectName("label_vcode")
        ...
        self.lineEdit_free.setGeometry(QtCore.QRect(20, 320, 441, 41))
        ...
        self.Button_CRF.setGeometry(QtCore.QRect(10, 110, 101, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.Box_encode.setItemText(0, _translate("Form", "CPU"))
        ...
        self.label_encode.setText(_translate("Form", "编码器"))
        self.label_preset.setText(_translate("Form", "压制预设"))
        self.encode_vcode.setItemText(0, _translate("Form", "H265"))
        self.encode_vcode.setItemText(1, _translate("Form", "H264"))
        self.label_vcode.setText(_translate("Form", "编码格式"))
